...
public final class AppUtils {
    ...
    public static boolean cleanAppData(File... dirs) {
        ...
        for (File dir : dirs) {
            CleanUtils.cleanCustomCache(dir.getPath());
            isSuccess =true;
        }
        return isSuccess;
    }
	...
	/**
	 * @purpose 判断某个Intent是存在的
	 * @param context
	 * @param action
	 * @return
	 */
	private boolean isActivity(Context context, String action) {
	 ...
	 * @return
	 */
	private boolean isLifeActivity(Context context, String packageName) {
